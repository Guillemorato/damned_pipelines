...
#Funcion 1 Pedimos que nos saque 100 resultados de la página
...
#Funcion 2 Funcion para chequear los commits que queremos
...
#Pipeline Functions 
#Funcion 1 Para crear la pull request
